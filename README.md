...
- Alexa-Fhem 0.5.64
        ...
        docker pull ghcr.io/fhem/fhem/alexa-fhem:v5.0.2

#### To start your container right away:

docker run -d --name alexa-fhem -p 3000:3000 ghcr.io/fhem/fhem/alexa-fhem:v5.0.2
...
services:
 ...
 alexa-fhem:
    image: ghcr.io/fhem/fhem/alexa-fhem:v5.0.2
    restart: always
    networks:
     - fhem_net
    ports:
